...
<body>
    ...
    <header>
                ...
                <div class="tt-header-holder">
                    <div class="tt-col-obj tt-obj-logo tt-obj-menu-categories tt-desctop-parent-menu-categories">
                        <a class="tt-logo tt-logo-alignment tt-menu-categories" title="Trang chủ thaomocuytin.com" href="/">
                            <img data-src="/images/logo_thaomocuytin.png" alt="Logo thaomocuytin.com">
                        </a>
                    </div>
                ...
                <div class="tt-dropdown-menu">
                    <div class="container">
                        <form action="/tim-kiem" method="get">
                            <div class="tt-col">
                                <label for="mobile-search-btn" class="hide">search</label>
                                <input id='mobile-search-btn' type="text" class="tt-search-input" name="keyword" placeholder="Sản phẩm bạn cần tìm...">
        ...
        <div class="tt-mobile-header">
            <div class="container-fluid tt-top-line" style="margin-top:-23px !important;">
    ...
    <script src="{{ asset('js/numeral.min.js') }}" defer></script>
